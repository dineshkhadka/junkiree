...
classDict = {'group1':'g1', 'group2':'g2', 'group3':'g3', 'group4':'g4', 'group5':'g5', 'group6':'g6', 'group7':'g7'}
groupDict = {'group1':'Group 1', 'group2':'Group 2', 'group3':'Group 3', 'group4':'Group 4', 'group5':'Group 5', 'group6':'Group 6', 'group7':'Group 7'}


notifTranslateDict = {'t1':'15 Minutes','t2':'30 Minutes','t3':'1 Hour'}
...
function initSetting(){
    ...
    // Notif time selector
    var notifEndsWith = /\d/;
    var thisNotifID = parseInt(storageNotifTime.match(notifEndsWith))-1;
...
function readForm(ev){
    ...
    if (ev == 'groupChanged'){  
        ...
        var setGroup = parseInt(ogval.match(gpat)) - 1 ;
        try{
...
optionGroup.addEventListener('change', function(){readForm('groupChanged');})
optionUpdate.addEventListener('change', function(){readForm('updateChanged');})
optionNotif.addEventListener('change', function(){readForm('notifChanged');})
optionNotifTime.addEventListener('change', function(){readForm('notifTimeChanged');})
optionMilitaryTime.addEventListener('change', function(){readForm('militaryChanged');})

updateClick.addEventListener('click', function(){jkParseRemoteSchedule(jkScheduleURL, true)});
